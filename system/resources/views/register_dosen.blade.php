    ...
    <main class="my-form">
        <div class="cotainer">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">Registrasi Dosen</div>
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()"
                                action="{{ url('store-register_dosen') }}" method="post">
                                @csrf
                                <div class="form-group row">
                                    <label for="full_name" class="col-md-4 col-form-label text-md-right">NIP</label>
                                    <div class="col-md-6">
                                        <input type="text" id="full_name" class="form-control" name="NIP">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="full_name" class="col-md-4 col-form-label text-md-right">Nama
                                        Lengkap</label>
                                    <div class="col-md-6">
                                        <input type="text" id="full_name" class="form-control" name="nama">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="email_address" class="form-control" name="username">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="email_address"
                                ...
                                <div class="form-group row">
                                    <label for="email_address"
                                        class="col-md-4 col-form-label text-md-right">No_hp</label>
                                    <div class="col-md-6">
